.class final Lio/sentry/transport/q;
...
.field private final c:Lio/sentry/transport/ReusableCountLatch;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(IILjava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;Lio/sentry/ILogger;)V
    ...
    iput-object p1, p0, Lio/sentry/transport/q;->c:Lio/sentry/transport/ReusableCountLatch;

    .line 3
    iput p2, p0, Lio/sentry/transport/q;->a:I

    .line 4
    iput-object p5, p0, Lio/sentry/transport/q;->b:Lio/sentry/ILogger;
...
.method private a()Z
    ...
    .line 1
    iget-object v0, p0, Lio/sentry/transport/q;->c:Lio/sentry/transport/ReusableCountLatch;

    invoke-virtual {v0}, Lio/sentry/transport/ReusableCountLatch;->getCount()I

    move-result v0

    iget v1, p0, Lio/sentry/transport/q;->a:I
...
.method protected afterExecute(Ljava/lang/Runnable;Ljava/lang/Throwable;)V
    ...
    .line 2
    iget-object p1, p0, Lio/sentry/transport/q;->c:Lio/sentry/transport/ReusableCountLatch;
    ...
    iget-object p2, p0, Lio/sentry/transport/q;->c:Lio/sentry/transport/ReusableCountLatch;
...
.method b(J)V
    ...
    .line 2
    iget-object p2, p0, Lio/sentry/transport/q;->b:Lio/sentry/ILogger;
...
.method public submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    .line 1
    invoke-direct {p0}, Lio/sentry/transport/q;->a()Z
    ...
    .line 4
    :cond_0
    iget-object p1, p0, Lio/sentry/transport/q;->b:Lio/sentry/ILogger;
    ...
    .line 5
    new-instance p1, Lio/sentry/transport/q$a;

    invoke-direct {p1}, Lio/sentry/transport/q$a;-><init>()V
