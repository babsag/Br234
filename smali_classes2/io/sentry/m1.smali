...
# instance fields
.field private final a:Lio/sentry/l1;
...
# direct methods
.method public constructor <init>(Lio/sentry/l1;Lio/sentry/SentryOptions;)V
    .locals 1
    .param p1    # Lio/sentry/l1;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iput-object p1, p0, Lio/sentry/m1;->a:Lio/sentry/l1;
...
.method private d(Z[Ljava/lang/StackTraceElement;Ljava/lang/Thread;)Lio/sentry/protocol/SentryThread;
    .locals 3
    ...
    .line 8
    iget-object p1, p0, Lio/sentry/m1;->a:Lio/sentry/l1;

    .line 9
    invoke-virtual {p1, p2}, Lio/sentry/l1;->a([Ljava/lang/StackTraceElement;)Ljava/util/List;

    move-result-object p1

    .line 10
    iget-object p2, p0, Lio/sentry/m1;->b:Lio/sentry/SentryOptions;
...
.method a()Ljava/util/List;
    ...
    .line 4
    invoke-virtual {p0, v0, v1}, Lio/sentry/m1;->c(Ljava/util/Map;Ljava/util/List;)Ljava/util/List;
...
.method b(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {p0, v0, p1}, Lio/sentry/m1;->c(Ljava/util/Map;Ljava/util/List;)Ljava/util/List;
...
.method c(Ljava/util/Map;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {p0, v3, v4, v2}, Lio/sentry/m1;->d(Z[Ljava/lang/StackTraceElement;Ljava/lang/Thread;)Lio/sentry/protocol/SentryThread;
