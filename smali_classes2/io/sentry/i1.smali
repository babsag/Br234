...
# direct methods
.method public constructor <init>(Lio/sentry/l1;)V
    .locals 1
...
.method private b(Ljava/lang/Throwable;Lio/sentry/protocol/Mechanism;Ljava/lang/Thread;Z)Lio/sentry/protocol/SentryException;
    .locals 6
    ...
    .line 7
    :goto_0
    iget-object v4, p0, Lio/sentry/i1;->a:Lio/sentry/l1;
    ...
    invoke-virtual {v4, p1}, Lio/sentry/l1;->a([Ljava/lang/StackTraceElement;)Ljava/util/List;
...
.method a(Ljava/lang/Throwable;)Ljava/util/Deque;
    ...
    .line 11
    :goto_1
    invoke-direct {p0, p1, v2, v4, v3}, Lio/sentry/i1;->b(Ljava/lang/Throwable;Lio/sentry/protocol/Mechanism;Ljava/lang/Thread;Z)Lio/sentry/protocol/SentryException;
...
.method c(Ljava/lang/Throwable;)Ljava/util/List;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lio/sentry/i1;->a(Ljava/lang/Throwable;)Ljava/util/Deque;

    move-result-object p1

    invoke-direct {p0, p1}, Lio/sentry/i1;->d(Ljava/util/Deque;)Ljava/util/List;
