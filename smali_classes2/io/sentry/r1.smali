...
.method public constructor <init>(Lio/sentry/SentryOptions;)V
    ...
    invoke-direct {p0, p1, v0}, Lio/sentry/r1;-><init>(Lio/sentry/SentryOptions;Ljava/security/SecureRandom;)V
...
.method constructor <init>(Lio/sentry/SentryOptions;Ljava/security/SecureRandom;)V
    ...
    .line 3
    iput-object p1, p0, Lio/sentry/r1;->a:Lio/sentry/SentryOptions;

    .line 4
    iput-object p2, p0, Lio/sentry/r1;->b:Ljava/security/SecureRandom;
...
.method private b(Ljava/lang/Double;)Z
    ...
    iget-object p1, p0, Lio/sentry/r1;->b:Ljava/security/SecureRandom;
...
# virtual methods
.method a(Lio/sentry/SamplingContext;)Lio/sentry/TracesSamplingDecision;
    .locals 7
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lio/sentry/r1;->a:Lio/sentry/SentryOptions;
    ...
    .line 4
    iget-object v2, p0, Lio/sentry/r1;->a:Lio/sentry/SentryOptions;
    ...
    .line 8
    invoke-direct {p0, v0}, Lio/sentry/r1;->b(Ljava/lang/Double;)Z
    ...
    .line 9
    iget-object v3, p0, Lio/sentry/r1;->a:Lio/sentry/SentryOptions;

    invoke-virtual {v3}, Lio/sentry/SentryOptions;->getTracesSampler()Lio/sentry/SentryOptions$TracesSamplerCallback;
    ...
    invoke-interface {v3, p1}, Lio/sentry/SentryOptions$TracesSamplerCallback;->sample(Lio/sentry/SamplingContext;)Ljava/lang/Double;
    ...
    .line 11
    iget-object v4, p0, Lio/sentry/r1;->a:Lio/sentry/SentryOptions;
    ...
    .line 15
    invoke-direct {p0, v3}, Lio/sentry/r1;->b(Ljava/lang/Double;)Z
    ...
    invoke-direct {p1, v1, v3, v2, v0}, Lio/sentry/TracesSamplingDecision;-><init>(Ljava/lang/Boolean;Ljava/lang/Double;Ljava/lang/Boolean;Ljava/lang/Double;)V
    ...
    .line 17
    :cond_5
    iget-object p1, p0, Lio/sentry/r1;->a:Lio/sentry/SentryOptions;
    ...
    .line 19
    invoke-direct {p0, p1}, Lio/sentry/r1;->b(Ljava/lang/Double;)Z
    ...
    invoke-direct {v1, v3, p1, v2, v0}, Lio/sentry/TracesSamplingDecision;-><init>(Ljava/lang/Boolean;Ljava/lang/Double;Ljava/lang/Boolean;Ljava/lang/Double;)V
    ...
    invoke-direct {p1, v0, v1, v0, v1}, Lio/sentry/TracesSamplingDecision;-><init>(Ljava/lang/Boolean;Ljava/lang/Double;Ljava/lang/Boolean;Ljava/lang/Double;)V
