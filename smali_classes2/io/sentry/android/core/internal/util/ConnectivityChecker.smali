...
.method private static a(Landroid/content/Context;Landroid/net/ConnectivityManager;Lio/sentry/ILogger;)Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;
    .locals 1
...
.method private static b(Landroid/content/Context;Lio/sentry/ILogger;)Landroid/net/ConnectivityManager;
    .locals 3
    .param p0    # Landroid/content/Context;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static getConnectionStatus(Landroid/content/Context;Lio/sentry/ILogger;)Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;
    ...
    .line 1
    invoke-static {p0, p1}, Lio/sentry/android/core/internal/util/ConnectivityChecker;->b(Landroid/content/Context;Lio/sentry/ILogger;)Landroid/net/ConnectivityManager;
    ...
    .line 3
    :cond_0
    invoke-static {p0, v0, p1}, Lio/sentry/android/core/internal/util/ConnectivityChecker;->a(Landroid/content/Context;Landroid/net/ConnectivityManager;Lio/sentry/ILogger;)Lio/sentry/android/core/internal/util/ConnectivityChecker$Status;
