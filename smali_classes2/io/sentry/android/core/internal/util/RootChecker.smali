...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/sentry/android/core/internal/util/RootChecker;->a:Ljava/nio/charset/Charset;
...
.method constructor <init>(Landroid/content/Context;Lio/sentry/android/core/BuildInfoProvider;Lio/sentry/ILogger;[Ljava/lang/String;[Ljava/lang/String;Ljava/lang/Runtime;)V
    ...
    iput-object p1, p0, Lio/sentry/android/core/internal/util/RootChecker;->b:Landroid/content/Context;
    ...
    iput-object p1, p0, Lio/sentry/android/core/internal/util/RootChecker;->c:Lio/sentry/android/core/BuildInfoProvider;
    ...
    iput-object p1, p0, Lio/sentry/android/core/internal/util/RootChecker;->d:Lio/sentry/ILogger;
    ...
    iput-object p1, p0, Lio/sentry/android/core/internal/util/RootChecker;->e:[Ljava/lang/String;
    ...
    iput-object p1, p0, Lio/sentry/android/core/internal/util/RootChecker;->f:[Ljava/lang/String;
    ...
    iput-object p1, p0, Lio/sentry/android/core/internal/util/RootChecker;->g:Ljava/lang/Runtime;
...
.method private a()Z
    ...
    .line 1
    iget-object v0, p0, Lio/sentry/android/core/internal/util/RootChecker;->e:[Ljava/lang/String;
    ...
    .line 3
    iget-object v7, p0, Lio/sentry/android/core/internal/util/RootChecker;->d:Lio/sentry/ILogger;
...
.method private b(Lio/sentry/ILogger;)Z
    ...
    .line 2
    iget-object p1, p0, Lio/sentry/android/core/internal/util/RootChecker;->b:Landroid/content/Context;
    ...
    .line 3
    iget-object v2, p0, Lio/sentry/android/core/internal/util/RootChecker;->f:[Ljava/lang/String;
...
.method private c()Z
    ...
    .line 2
    :try_start_0
    iget-object v3, p0, Lio/sentry/android/core/internal/util/RootChecker;->g:Ljava/lang/Runtime;
    ...
    sget-object v5, Lio/sentry/android/core/internal/util/RootChecker;->a:Ljava/nio/charset/Charset;
    ...
    .line 9
    :try_start_5
    iget-object v3, p0, Lio/sentry/android/core/internal/util/RootChecker;->d:Lio/sentry/ILogger;
    ...
    :catch_0
    :try_start_6
    iget-object v0, p0, Lio/sentry/android/core/internal/util/RootChecker;->d:Lio/sentry/ILogger;
...
.method private d()Z
    ...
    .line 1
    iget-object v0, p0, Lio/sentry/android/core/internal/util/RootChecker;->c:Lio/sentry/android/core/BuildInfoProvider;
...
.method public isDeviceRooted()Z
    ...
    .line 1
    invoke-direct {p0}, Lio/sentry/android/core/internal/util/RootChecker;->d()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0}, Lio/sentry/android/core/internal/util/RootChecker;->a()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-direct {p0}, Lio/sentry/android/core/internal/util/RootChecker;->c()Z
    ...
    invoke-direct {p0, v0}, Lio/sentry/android/core/internal/util/RootChecker;->b(Lio/sentry/ILogger;)Z
