...
.method public constructor <init>(Lio/sentry/SentryOptions;Ljava/lang/String;I)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3}, Lio/sentry/cache/c;-><init>(Lio/sentry/SentryOptions;Ljava/lang/String;I)V
    ...
    iput-object p1, p0, Lio/sentry/cache/EnvelopeCache;->b:Ljava/util/Map;
...
.method private l()[Ljava/io/File;
    ...
    .line 1
    invoke-virtual {p0}, Lio/sentry/cache/c;->isDirectoryValid()Z
...
.method private m()Ljava/io/File;
    ...
    iget-object v1, p0, Lio/sentry/cache/c;->directory:Ljava/io/File;
...
.method private declared-synchronized n(Lio/sentry/SentryEnvelope;)Ljava/io/File;
    .locals 2
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/sentry/cache/EnvelopeCache;->b:Ljava/util/Map;
    ...
    .line 7
    iget-object v1, p0, Lio/sentry/cache/EnvelopeCache;->b:Ljava/util/Map;
...
.method private o(Ljava/io/File;)Ljava/util/Date;
    .locals 6
    ...
    .line 3
    iget-object v2, p0, Lio/sentry/cache/c;->options:Lio/sentry/SentryOptions;
...
.method static synthetic p(Ljava/io/File;Ljava/lang/String;)Z
    .locals 0
...
.method private q(Ljava/io/File;Lio/sentry/SentryEnvelope;)V
    .locals 6
    .param p1    # Ljava/io/File;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    sget-object v5, Lio/sentry/cache/c;->UTF_8:Ljava/nio/charset/Charset;
    ...
    .line 7
    :try_start_1
    iget-object v3, p0, Lio/sentry/cache/c;->serializer:Lio/sentry/ISerializer;
    ...
    .line 8
    iget-object p1, p0, Lio/sentry/cache/c;->options:Lio/sentry/SentryOptions;
    ...
    .line 12
    :cond_0
    invoke-direct {p0, p1, v3}, Lio/sentry/cache/EnvelopeCache;->t(Ljava/io/File;Lio/sentry/Session;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private r()V
    ...
    .line 4
    sget-object v2, Lio/sentry/cache/c;->UTF_8:Ljava/nio/charset/Charset;
...
.method private s(Ljava/io/File;Lio/sentry/SentryEnvelope;)V
    .locals 6
    .param p1    # Ljava/io/File;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method private t(Ljava/io/File;Lio/sentry/Session;)V
    .locals 6
    .param p1    # Ljava/io/File;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    sget-object v4, Lio/sentry/cache/c;->UTF_8:Ljava/nio/charset/Charset;
...
.method public discard(Lio/sentry/SentryEnvelope;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lio/sentry/cache/EnvelopeCache;->n(Lio/sentry/SentryEnvelope;)Ljava/io/File;
...
.method public iterator()Ljava/util/Iterator;
    ...
    .line 1
    invoke-direct {p0}, Lio/sentry/cache/EnvelopeCache;->l()[Ljava/io/File;
    ...
    .line 5
    :try_start_1
    iget-object v8, p0, Lio/sentry/cache/c;->serializer:Lio/sentry/ISerializer;
    ...
    .line 8
    iget-object v8, p0, Lio/sentry/cache/c;->options:Lio/sentry/SentryOptions;
...
.method public store(Lio/sentry/SentryEnvelope;Lio/sentry/Hint;)V
    ...
    invoke-virtual {p0, v0}, Lio/sentry/cache/c;->rotateCacheIfNeeded([Ljava/io/File;)V

    .line 3
    invoke-direct {p0}, Lio/sentry/cache/EnvelopeCache;->m()Ljava/io/File;
    ...
    sget-object v7, Lio/sentry/cache/c;->UTF_8:Ljava/nio/charset/Charset;
    ...
    .line 11
    :try_start_1
    iget-object v5, p0, Lio/sentry/cache/c;->serializer:Lio/sentry/ISerializer;
    ...
    .line 12
    iget-object v5, p0, Lio/sentry/cache/c;->options:Lio/sentry/SentryOptions;
    ...
    .line 22
    invoke-direct {p0, v6}, Lio/sentry/cache/EnvelopeCache;->o(Ljava/io/File;)Ljava/util/Date;
    ...
    .line 24
    iget-object v9, p0, Lio/sentry/cache/c;->options:Lio/sentry/SentryOptions;
    ...
    .line 30
    iget-object v7, p0, Lio/sentry/cache/c;->serializer:Lio/sentry/ISerializer;
    ...
    .line 32
    invoke-direct {p0, v5}, Lio/sentry/cache/EnvelopeCache;->n(Lio/sentry/SentryEnvelope;)Ljava/io/File;

    move-result-object v7

    .line 33
    invoke-direct {p0, v7, v5}, Lio/sentry/cache/EnvelopeCache;->s(Ljava/io/File;Lio/sentry/SentryEnvelope;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
    ...
    :cond_5
    :goto_6
    invoke-direct {p0, v0, p1}, Lio/sentry/cache/EnvelopeCache;->q(Ljava/io/File;Lio/sentry/SentryEnvelope;)V
    ...
    .line 60
    invoke-direct {p0, v0, p1}, Lio/sentry/cache/EnvelopeCache;->s(Ljava/io/File;Lio/sentry/SentryEnvelope;)V
    ...
    .line 62
    invoke-direct {p0}, Lio/sentry/cache/EnvelopeCache;->r()V
