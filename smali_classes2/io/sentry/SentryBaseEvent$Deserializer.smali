...
.method public deserializeValue(Lio/sentry/SentryBaseEvent;Ljava/lang/String;Lio/sentry/JsonObjectReader;Lio/sentry/ILogger;)Z
    ...
    .param p2    # Ljava/lang/String;
        ...
        .end annotation
    .end param
    .param p3    # Lio/sentry/JsonObjectReader;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->u(Lio/sentry/SentryBaseEvent;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->m(Lio/sentry/SentryBaseEvent;Lio/sentry/protocol/Request;)Lio/sentry/protocol/Request;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->q(Lio/sentry/SentryBaseEvent;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->b(Lio/sentry/SentryBaseEvent;Lio/sentry/protocol/SentryId;)Lio/sentry/protocol/SentryId;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->i(Lio/sentry/SentryBaseEvent;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->w(Lio/sentry/SentryBaseEvent;Lio/sentry/protocol/User;)Lio/sentry/protocol/User;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->o(Lio/sentry/SentryBaseEvent;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->e(Lio/sentry/SentryBaseEvent;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->k(Lio/sentry/SentryBaseEvent;Lio/sentry/protocol/SdkVersion;)Lio/sentry/protocol/SdkVersion;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->g(Lio/sentry/SentryBaseEvent;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->s(Lio/sentry/SentryBaseEvent;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lio/sentry/SentryBaseEvent;->y(Lio/sentry/SentryBaseEvent;Ljava/lang/String;)Ljava/lang/String;
