...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lcom/google/firebase/crashlytics/internal/common/Utils$a;

    invoke-direct {v0}, Lcom/google/firebase/crashlytics/internal/common/Utils$a;-><init>()V
...
.method static a(Ljava/io/File;ILjava/util/Comparator;)I
    ...
    invoke-static {p0, v0, p1, p2}, Lcom/google/firebase/crashlytics/internal/common/Utils;->b(Ljava/io/File;Ljava/io/FilenameFilter;ILjava/util/Comparator;)I
...
.method public static awaitEvenIfOnMainThread(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lcom/google/firebase/crashlytics/internal/common/t;->a(Ljava/util/concurrent/CountDownLatch;)Lcom/google/android/gms/tasks/Continuation;
...
.method static b(Ljava/io/File;Ljava/io/FilenameFilter;ILjava/util/Comparator;)I
    ...
    invoke-static {p0, p2, p3}, Lcom/google/firebase/crashlytics/internal/common/Utils;->c(Ljava/util/List;ILjava/util/Comparator;)I
...
.method static c(Ljava/util/List;ILjava/util/Comparator;)I
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    :cond_0
    invoke-static {p2}, Lcom/google/firebase/crashlytics/internal/common/Utils;->f(Ljava/io/File;)V
...
.method public static callTask(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 2
    new-instance v1, Lcom/google/firebase/crashlytics/internal/common/Utils$c;

    invoke-direct {v1, p1, v0}, Lcom/google/firebase/crashlytics/internal/common/Utils$c;-><init>(Ljava/util/concurrent/Callable;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
...
.method static d(Ljava/io/File;Ljava/io/File;ILjava/util/Comparator;)I
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    sget-object v1, Lcom/google/firebase/crashlytics/internal/common/Utils;->a:Ljava/io/FilenameFilter;
    ...
    .line 6
    invoke-static {v0, p2, p3}, Lcom/google/firebase/crashlytics/internal/common/Utils;->c(Ljava/util/List;ILjava/util/Comparator;)I
...
.method static synthetic e(Ljava/util/concurrent/CountDownLatch;Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method private static f(Ljava/io/File;)V
    ...
    .line 3
    invoke-static {v3}, Lcom/google/firebase/crashlytics/internal/common/Utils;->f(Ljava/io/File;)V
...
.method public static race(Lcom/google/android/gms/tasks/Task;Lcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 2
    new-instance v1, Lcom/google/firebase/crashlytics/internal/common/Utils$b;

    invoke-direct {v1, v0}, Lcom/google/firebase/crashlytics/internal/common/Utils$b;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
