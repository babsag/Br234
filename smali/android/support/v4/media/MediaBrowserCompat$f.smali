...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/media/MediaBrowserCompat$f$g;
    }
.end annotation
...
.field h:Landroid/support/v4/media/MediaBrowserCompat$f$g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/MediaBrowserCompat$ConnectionCallback;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:Landroidx/collection/ArrayMap;
...
.method b()V
    ...
    invoke-static {v2}, Landroid/support/v4/media/MediaBrowserCompat$f;->d(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->h:Landroid/support/v4/media/MediaBrowserCompat$f$g;
...
.method c()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->h:Landroid/support/v4/media/MediaBrowserCompat$f$g;
    ...
    .line 4
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->h:Landroid/support/v4/media/MediaBrowserCompat$f$g;
...
.method public disconnect()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/media/MediaBrowserCompat$f$b;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;)V
...
.method public e(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    .locals 3
    ...
    invoke-virtual {v1, p1, p2, v0, v2}, Landroid/support/v4/media/MediaBrowserCompat$h;->h(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    :try_end_0
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$f$f;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public f(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Landroid/support/v4/media/MediaBrowserCompat$f;->p(Landroid/os/Messenger;Ljava/lang/String;)Z
    ...
    invoke-static {p2}, Landroid/support/v4/media/MediaBrowserCompat$f;->d(I)Ljava/lang/String;
    ...
    .line 12
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:Landroidx/collection/ArrayMap;
...
.method public h(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 4
    :cond_1
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:Landroidx/collection/ArrayMap;
    ...
    .line 6
    :cond_3
    invoke-virtual {v1, p4}, Landroid/support/v4/media/MediaBrowserCompat$i;->a(Landroid/os/Bundle;)Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;
...
.method public i(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
    .locals 4
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v1, p0, p2, p1}, Landroid/support/v4/media/MediaBrowserCompat$f$c;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1, v0, v3}, Landroid/support/v4/media/MediaBrowserCompat$h;->d(Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p0, p2, p1}, Landroid/support/v4/media/MediaBrowserCompat$f$d;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;Ljava/lang/String;)V
...
.method public j()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/media/MediaBrowserCompat$f$a;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;)V
...
.method public k(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:Landroidx/collection/ArrayMap;
...
.method public l(Landroid/os/Messenger;)V
    ...
    invoke-static {v0}, Landroid/support/v4/media/MediaBrowserCompat$f;->d(I)Ljava/lang/String;
...
.method public m(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    invoke-virtual {v1, p1, v2, v3}, Landroid/support/v4/media/MediaBrowserCompat$h;->f(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Messenger;)V
    ...
    invoke-virtual {v4, p1, v5, v6}, Landroid/support/v4/media/MediaBrowserCompat$h;->f(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Messenger;)V
    ...
    .line 14
    :cond_5
    iget-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:Landroidx/collection/ArrayMap;
...
.method public n(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;)V
    .locals 3
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v1, p1, p2, v0, v2}, Landroid/support/v4/media/MediaBrowserCompat$h;->g(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$f$e;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 7
    invoke-static {p3}, Landroid/support/v4/media/MediaBrowserCompat$f;->d(I)Ljava/lang/String;
