...
.method a(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;Landroid/os/Messenger;)V
    ...
    .line 5
    invoke-direct {p0, p1, v0, p4}, Landroid/support/v4/media/MediaBrowserCompat$h;->i(ILandroid/os/Bundle;Landroid/os/Messenger;)V
...
.method b(Landroid/content/Context;Landroid/os/Messenger;)V
    ...
    .line 4
    invoke-direct {p0, p1, v0, p2}, Landroid/support/v4/media/MediaBrowserCompat$h;->i(ILandroid/os/Bundle;Landroid/os/Messenger;)V
...
.method c(Landroid/os/Messenger;)V
    ...
    .line 1
    invoke-direct {p0, v0, v1, p1}, Landroid/support/v4/media/MediaBrowserCompat$h;->i(ILandroid/os/Bundle;Landroid/os/Messenger;)V

    return-void
.end method

.method d(Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .line 4
    invoke-direct {p0, p1, v0, p3}, Landroid/support/v4/media/MediaBrowserCompat$h;->i(ILandroid/os/Bundle;Landroid/os/Messenger;)V
...
.method g(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method h(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
