...
.method private a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$i;->u:Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, v0, Landroid/support/v4/media/session/MediaSessionCompat$i;->q:Landroid/support/v4/media/session/MediaSessionCompat$Callback;
    ...
    .line 6
    invoke-virtual {v2, v3}, Landroid/support/v4/media/session/MediaSessionCompat$i;->o(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    invoke-virtual {v0, p1, v4}, Landroid/support/v4/media/session/MediaSessionCompat$i;->L(II)V
    ...
    .line 26
    invoke-direct {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat$i$d;->a(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    invoke-virtual {v0, p1, v4}, Landroid/support/v4/media/session/MediaSessionCompat$i;->t(II)V
    ...
    invoke-virtual {p1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->o(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->o(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
