...
.method K(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 6
    :cond_1
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$i;->i:Landroid/media/RemoteControlClient;
...
.method M(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 1
    sget-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$e;->H:Z

    if-eqz v0, :cond_0

    .line 2
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$i;->h:Landroid/media/AudioManager;
    ...
    .line 3
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->M(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public f(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$i;->f(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 4
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$i;->i:Landroid/media/RemoteControlClient;
...
.method y(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 4
    sput-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$e;->H:Z
