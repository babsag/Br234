...
.method private C(Landroidx/transition/TransitionValues;)V
    ...
    .line 12
    invoke-static {v1}, Landroidx/transition/ChangeImageTransform;->E(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private static E(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .line 5
    :cond_1
    invoke-static {p0}, Landroidx/transition/ChangeImageTransform;->H(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private F(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 4
...
.method private G(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    .locals 5
    ...
    sget-object v3, Landroidx/transition/j;->a:Landroid/graphics/Matrix;
...
.method private static H(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 4
...
.method public captureEndValues(Landroidx/transition/TransitionValues;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->C(Landroidx/transition/TransitionValues;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 11
    sget-object p2, Landroidx/transition/j;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    .line 12
    sget-object v2, Landroidx/transition/j;->a:Landroid/graphics/Matrix;
    ...
    .line 14
    invoke-direct {p0, p1, p2, v2}, Landroidx/transition/ChangeImageTransform;->F(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->G(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
