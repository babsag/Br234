...
.method public static setEntries(Landroid/widget/AbsSpinner;Ljava/util/List;)V
    ...
    .line 11
    instance-of v1, v0, Landroidx/databinding/adapters/a;

    if-eqz v1, :cond_0

    .line 12
    check-cast v0, Landroidx/databinding/adapters/a;

    invoke-virtual {v0, p1}, Landroidx/databinding/adapters/a;->b(Ljava/util/List;)V

    goto :goto_0

    .line 13
    :cond_0
    new-instance v0, Landroidx/databinding/adapters/a;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/databinding/adapters/a;-><init>(Landroid/content/Context;Ljava/util/List;III)V
