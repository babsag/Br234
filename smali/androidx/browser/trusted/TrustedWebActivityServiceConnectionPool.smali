...
.method private a(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
    .locals 7
...
.method public synthetic c(Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->b(Landroid/net/Uri;)V
...
.method public connect(Landroid/net/Uri;Ljava/util/Set;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    check-cast v0, Landroidx/browser/trusted/d;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0}, Landroidx/browser/trusted/d;->b()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 4
    invoke-direct {p0, v0, p1, p2, v1}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
    ...
    invoke-static {p1}, Landroidx/browser/trusted/e;->a(Ljava/lang/Throwable;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v1, p0, p1}, Landroidx/browser/trusted/c;-><init>(Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;Landroid/net/Uri;)V

    invoke-direct {v0, v1}, Landroidx/browser/trusted/d;-><init>(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p1, v1, p2, v0}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool$a;-><init>(Landroid/content/Context;Landroid/content/Intent;Landroidx/browser/trusted/d;)V
...
.method public serviceExistsForScope(Landroid/net/Uri;Ljava/util/Set;)Z
    ...
    invoke-direct {p0, v0, p1, p2, v2}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
