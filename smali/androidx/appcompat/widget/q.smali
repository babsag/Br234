...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/q$g;,
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/q;->i:Landroidx/appcompat/widget/r;
...
.method private B(IF)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/q;->i:Landroidx/appcompat/widget/r;

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/r;->w(IF)V
...
.method private C(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    .line 23
    :goto_2
    invoke-static {p1, v0, v6}, Landroidx/appcompat/widget/q$g;->a(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
    ...
    .line 30
    :cond_d
    invoke-static {p1, p2, v4}, Landroidx/appcompat/widget/q$g;->a(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
...
.method private y(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;

    invoke-static {p1}, Landroidx/appcompat/widget/q$c;->a(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 3
    iget-object p3, p0, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;
    ...
    .line 8
    :goto_3
    invoke-static {p3, p5, p2, p6, p4}, Landroidx/appcompat/widget/q$c;->b(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 9
    iget-object p5, p0, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;

    invoke-static {p5}, Landroidx/appcompat/widget/q$c;->a(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
    ...
    .line 14
    :goto_5
    invoke-static {p1, p3, p2, p6, p4}, Landroidx/appcompat/widget/q$c;->b(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 16
    iget-object p6, p0, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;
...
.method b()V
    ...
    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
    ...
    invoke-direct {p0, v0, v3}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/q$c;->a(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v2, v3}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
    ...
    invoke-direct {p0, v0, v1}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;)V
...
.method i()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/r;->l()I
...
.method l()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/r;->q()Z
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    .line 1
    iget-object v0, v7, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;
    ...
    .line 10
    invoke-static {v10, v11, v1}, Landroidx/appcompat/widget/q;->d(Landroid/content/Context;Landroidx/appcompat/widget/AppCompatDrawableManager;I)Landroidx/appcompat/widget/TintInfo;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/q;->b:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/q;->c:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/q;->d:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/q;->e:Landroidx/appcompat/widget/TintInfo;
    ...
    .line 23
    invoke-static {v10, v11, v2}, Landroidx/appcompat/widget/q;->d(Landroid/content/Context;Landroidx/appcompat/widget/AppCompatDrawableManager;I)Landroidx/appcompat/widget/TintInfo;

    move-result-object v2

    iput-object v2, v7, Landroidx/appcompat/widget/q;->f:Landroidx/appcompat/widget/TintInfo;
    ...
    iput-object v2, v7, Landroidx/appcompat/widget/q;->g:Landroidx/appcompat/widget/TintInfo;
    ...
    .line 28
    iget-object v2, v7, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;
    ...
    .line 33
    :goto_0
    invoke-direct {v7, v10, v0}, Landroidx/appcompat/widget/q;->C(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    .line 63
    iget-object v11, v7, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;
    ...
    .line 69
    invoke-virtual {v7, v6}, Landroidx/appcompat/widget/q;->s(Z)V

    .line 70
    :cond_19
    iget-object v0, v7, Landroidx/appcompat/widget/q;->l:Landroid/graphics/Typeface;

    if-eqz v0, :cond_1b

    .line 71
    iget v2, v7, Landroidx/appcompat/widget/q;->k:I
    ...
    iget v4, v7, Landroidx/appcompat/widget/q;->j:I
    ...
    invoke-static {v0, v3}, Landroidx/appcompat/widget/q$f;->d(Landroid/widget/TextView;Ljava/lang/String;)Z
    ...
    invoke-static {v5}, Landroidx/appcompat/widget/q$e;->a(Ljava/lang/String;)Landroid/os/LocaleList;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/appcompat/widget/q$e;->b(Landroid/widget/TextView;Landroid/os/LocaleList;)V
    ...
    .line 77
    iget-object v1, v7, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;

    invoke-static {v0}, Landroidx/appcompat/widget/q$d;->a(Ljava/lang/String;)Ljava/util/Locale;

    move-result-object v0

    invoke-static {v1, v0}, Landroidx/appcompat/widget/q$c;->c(Landroid/widget/TextView;Ljava/util/Locale;)V

    .line 78
    :cond_1e
    :goto_b
    iget-object v0, v7, Landroidx/appcompat/widget/q;->i:Landroidx/appcompat/widget/r;

    move-object/from16 v1, p1

    invoke-virtual {v0, v1, v9}, Landroidx/appcompat/widget/r;->r(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v2}, Landroidx/appcompat/widget/q$f;->a(Landroid/widget/TextView;)I
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/q;->i:Landroidx/appcompat/widget/r;

    .line 86
    invoke-virtual {v2}, Landroidx/appcompat/widget/r;->i()I

    move-result v2

    iget-object v3, v7, Landroidx/appcompat/widget/q;->i:Landroidx/appcompat/widget/r;
    ...
    iget-object v4, v7, Landroidx/appcompat/widget/q;->i:Landroidx/appcompat/widget/r;

    .line 88
    invoke-virtual {v4}, Landroidx/appcompat/widget/r;->j()I
    ...
    .line 89
    invoke-static {v0, v2, v3, v4, v5}, Landroidx/appcompat/widget/q$f;->b(Landroid/widget/TextView;IIII)V
    ...
    invoke-static {v2, v0, v5}, Landroidx/appcompat/widget/q$f;->c(Landroid/widget/TextView;[II)V
    ...
    .line 104
    invoke-direct/range {v0 .. v6}, Landroidx/appcompat/widget/q;->y(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 116
    iget-object v4, v7, Landroidx/appcompat/widget/q;->a:Landroid/widget/TextView;
...
.method n(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/appcompat/widget/q;->m:Z

    if-eqz v0, :cond_1

    .line 2
    iput-object p2, p0, Landroidx/appcompat/widget/q;->l:Landroid/graphics/Typeface;
    ...
    invoke-direct {v1, p0, p1, p2, v0}, Landroidx/appcompat/widget/q$b;-><init>(Landroidx/appcompat/widget/q;Landroid/widget/TextView;Landroid/graphics/Typeface;I)V
...
.method q(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/q;->s(Z)V
    ...
    .line 17
    :cond_4
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/q;->C(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    invoke-static {v0, p1}, Landroidx/appcompat/widget/q$f;->d(Landroid/widget/TextView;Ljava/lang/String;)Z
...
.method t(IIII)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroidx/appcompat/widget/r;->s(IIII)V
...
.method u([II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/r;->t([II)V
...
.method v(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/r;->u(I)V
...
.method w(Landroid/content/res/ColorStateList;)V
    ...
    .line 5
    invoke-direct {p0}, Landroidx/appcompat/widget/q;->z()V
