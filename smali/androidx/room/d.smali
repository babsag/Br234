...
.field private final e:Landroidx/sqlite/db/SupportSQLiteOpenHelper;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field

.field private f:Landroidx/room/DatabaseConfiguration;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;ILandroidx/sqlite/db/SupportSQLiteOpenHelper;)V
    ...
    .line 4
    iput-object p3, p0, Landroidx/room/d;->c:Ljava/io/File;

    .line 5
    iput p4, p0, Landroidx/room/d;->d:I

    .line 6
    iput-object p5, p0, Landroidx/room/d;->e:Landroidx/sqlite/db/SupportSQLiteOpenHelper;
...
.method private a(Ljava/io/File;)V
    ...
    .line 2
    iget-object v0, p0, Landroidx/room/d;->a:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getAssets()Landroid/content/res/AssetManager;

    move-result-object v0

    iget-object v1, p0, Landroidx/room/d;->b:Ljava/lang/String;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Landroidx/room/d;->c:Ljava/io/File;
    ...
    iget-object v1, p0, Landroidx/room/d;->c:Ljava/io/File;
    ...
    .line 5
    :goto_0
    iget-object v1, p0, Landroidx/room/d;->a:Landroid/content/Context;
...
.method private c()V
    ...
    .line 2
    iget-object v2, p0, Landroidx/room/d;->a:Landroid/content/Context;
    ...
    .line 3
    iget-object v3, p0, Landroidx/room/d;->f:Landroidx/room/DatabaseConfiguration;
    ...
    iget-object v5, p0, Landroidx/room/d;->a:Landroid/content/Context;
    ...
    .line 7
    :try_start_1
    invoke-direct {p0, v2}, Landroidx/room/d;->a(Ljava/io/File;)V
    :try_end_1
    ...
    .line 13
    :try_start_4
    iget v6, p0, Landroidx/room/d;->d:I
    :try_end_4
    ...
    :cond_4
    :try_start_5
    iget-object v7, p0, Landroidx/room/d;->f:Landroidx/room/DatabaseConfiguration;
    ...
    :cond_5
    :try_start_6
    iget-object v3, p0, Landroidx/room/d;->a:Landroid/content/Context;
...
.method b(Landroidx/room/DatabaseConfiguration;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/room/d;->f:Landroidx/room/DatabaseConfiguration;
...
.method public declared-synchronized close()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Landroidx/room/d;->e:Landroidx/sqlite/db/SupportSQLiteOpenHelper;
    ...
    .line 2
    iput-boolean v0, p0, Landroidx/room/d;->g:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized getReadableDatabase()Landroidx/sqlite/db/SupportSQLiteDatabase;
    ...
    .line 2
    invoke-direct {p0}, Landroidx/room/d;->c()V
