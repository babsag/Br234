...
.field volatile h:Landroidx/sqlite/db/SupportSQLiteStatement;

.field private i:Landroidx/room/InvalidationTracker$b;

.field private final j:Landroidx/room/a;

.field final k:Landroidx/arch/core/internal/SafeIterableMap;
...
.field private l:Landroidx/room/b;
...
.method public varargs constructor <init>(Landroidx/room/RoomDatabase;Ljava/util/Map;Ljava/util/Map;[Ljava/lang/String;)V
    ...
    iput-object v0, p0, Landroidx/room/InvalidationTracker;->m:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroidx/room/InvalidationTracker;->i:Landroidx/room/InvalidationTracker$b;
    ...
    invoke-direct {p3, p1}, Landroidx/room/a;-><init>(Landroidx/room/RoomDatabase;)V

    iput-object p3, p0, Landroidx/room/InvalidationTracker;->j:Landroidx/room/a;
...
.method private f(Landroidx/sqlite/db/SupportSQLiteDatabase;I)V
    .locals 8
...
.method private h(Landroidx/sqlite/db/SupportSQLiteDatabase;I)V
    .locals 7
...
.method private k([Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/room/InvalidationTracker;->d([Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 3
    iget-object v3, p0, Landroidx/room/InvalidationTracker;->b:Ljava/util/HashMap;
...
.method public addObserver(Landroidx/room/InvalidationTracker$Observer;)V
    ...
    invoke-direct {p0, v0}, Landroidx/room/InvalidationTracker;->d([Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 9
    :try_start_0
    iget-object v3, p0, Landroidx/room/InvalidationTracker;->k:Landroidx/arch/core/internal/SafeIterableMap;
    ...
    .line 11
    iget-object p1, p0, Landroidx/room/InvalidationTracker;->i:Landroidx/room/InvalidationTracker$b;
...
.method c(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/room/InvalidationTracker;->h:Landroidx/sqlite/db/SupportSQLiteStatement;

    const/4 p1, 0x1

    .line 10
    iput-boolean p1, p0, Landroidx/room/InvalidationTracker;->g:Z
...
.method public createLiveData([Ljava/lang/String;ZLjava/util/concurrent/Callable;)Landroidx/lifecycle/LiveData;
    ...
    .line 2
    iget-object v0, p0, Landroidx/room/InvalidationTracker;->j:Landroidx/room/a;

    .line 3
    invoke-direct {p0, p1}, Landroidx/room/InvalidationTracker;->k([Ljava/lang/String;)[Ljava/lang/String;

    move-result-object p1

    .line 4
    invoke-virtual {v0, p1, p2, p3}, Landroidx/room/a;->a([Ljava/lang/String;ZLjava/util/concurrent/Callable;)Landroidx/lifecycle/LiveData;
...
.method e(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Landroidx/room/InvalidationTracker;->e:Landroidx/room/RoomDatabase;
    ...
    invoke-direct {v0, p1, p2, p0, v1}, Landroidx/room/b;-><init>(Landroid/content/Context;Ljava/lang/String;Landroidx/room/InvalidationTracker;Ljava/util/concurrent/Executor;)V

    iput-object v0, p0, Landroidx/room/InvalidationTracker;->l:Landroidx/room/b;
...
.method g()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/room/InvalidationTracker;->l:Landroidx/room/b;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0}, Landroidx/room/b;->a()V
...
.method j(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    .locals 6
    ...
    .line 4
    :try_start_1
    iget-object v1, p0, Landroidx/room/InvalidationTracker;->i:Landroidx/room/InvalidationTracker$b;
    ...
    .line 9
    :cond_2
    invoke-direct {p0, p1, v3}, Landroidx/room/InvalidationTracker;->h(Landroidx/sqlite/db/SupportSQLiteDatabase;I)V

    goto :goto_2

    .line 10
    :cond_3
    invoke-direct {p0, p1, v3}, Landroidx/room/InvalidationTracker;->f(Landroidx/sqlite/db/SupportSQLiteDatabase;I)V
...
.method public refreshVersionsAsync()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/room/InvalidationTracker;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, Landroidx/room/InvalidationTracker;->m:Ljava/lang/Runnable;
...
.method public refreshVersionsSync()V
    ...
    .line 2
    iget-object v0, p0, Landroidx/room/InvalidationTracker;->m:Ljava/lang/Runnable;
...
.method public removeObserver(Landroidx/room/InvalidationTracker$Observer;)V
    ...
    .line 4
    iget-object v0, p0, Landroidx/room/InvalidationTracker;->i:Landroidx/room/InvalidationTracker$b;
