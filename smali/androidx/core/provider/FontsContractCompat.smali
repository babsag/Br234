...
.method public static fetchFonts(Landroid/content/Context;Landroid/os/CancellationSignal;Landroidx/core/provider/FontRequest;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
    ...
    .line 1
    invoke-static {p0, p2, p1}, Landroidx/core/provider/d;->d(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroid/os/CancellationSignal;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
...
.method public static getProvider(Landroid/content/pm/PackageManager;Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    .line 1
    invoke-static {p0, p1, p2}, Landroidx/core/provider/d;->e(Landroid/content/pm/PackageManager;Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
...
.method public static requestFont(Landroid/content/Context;Landroidx/core/provider/FontRequest;IZILandroid/os/Handler;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;)Landroid/graphics/Typeface;
    ...
    invoke-direct {v0, p6, p5}, Landroidx/core/provider/b;-><init>(Landroidx/core/provider/FontsContractCompat$FontRequestCallback;Landroid/os/Handler;)V

    if-eqz p3, :cond_0

    .line 5
    invoke-static {p0, p1, v0, p2, p4}, Landroidx/core/provider/e;->e(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/provider/b;II)Landroid/graphics/Typeface;
    ...
    .line 6
    invoke-static {p0, p1, p2, p3, v0}, Landroidx/core/provider/e;->d(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/util/concurrent/Executor;Landroidx/core/provider/b;)Landroid/graphics/Typeface;
...
.method public static requestFont(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;Landroid/os/Handler;)V
    ...
    invoke-direct {v0, p2}, Landroidx/core/provider/b;-><init>(Landroidx/core/provider/FontsContractCompat$FontRequestCallback;)V

    .line 2
    invoke-static {p3}, Landroidx/core/provider/f;->b(Landroid/os/Handler;)Ljava/util/concurrent/Executor;
    ...
    invoke-static {p0, p1, p3, p2, v0}, Landroidx/core/provider/e;->d(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/util/concurrent/Executor;Landroidx/core/provider/b;)Landroid/graphics/Typeface;
...
.method public static resetCache()V
    ...
    .line 1
    invoke-static {}, Landroidx/core/provider/e;->f()V
