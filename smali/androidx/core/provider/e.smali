...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/core/provider/e;->d:Landroidx/collection/SimpleArrayMap;
...
.method static c(Ljava/lang/String;Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/e$e;
    .locals 3
    ...
    .line 1
    sget-object v0, Landroidx/core/provider/e;->a:Landroidx/collection/LruCache;
    ...
    .line 3
    :try_start_0
    invoke-static {p1, p2, v1}, Landroidx/core/provider/d;->d(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroid/os/CancellationSignal;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
    ...
    .line 4
    invoke-static {p2}, Landroidx/core/provider/e;->b(Landroidx/core/provider/FontsContractCompat$FontFamilyResult;)I
...
.method static d(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/util/concurrent/Executor;Landroidx/core/provider/b;)Landroid/graphics/Typeface;
    .locals 5
    ...
    .param p3    # Ljava/util/concurrent/Executor;
        ...
        .end annotation
    .end param
    .param p4    # Landroidx/core/provider/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param

    .line 1
    invoke-static {p1, p2}, Landroidx/core/provider/e;->a(Landroidx/core/provider/FontRequest;I)Ljava/lang/String;
    ...
    invoke-virtual {p4, p0}, Landroidx/core/provider/b;->b(Landroidx/core/provider/e$e;)V
    ...
    invoke-direct {v1, p4}, Landroidx/core/provider/e$b;-><init>(Landroidx/core/provider/b;)V
    ...
    .line 6
    :try_start_0
    sget-object v2, Landroidx/core/provider/e;->d:Landroidx/collection/SimpleArrayMap;
    ...
    invoke-direct {p4, v0, p0, p1, p2}, Landroidx/core/provider/e$c;-><init>(Ljava/lang/String;Landroid/content/Context;Landroidx/core/provider/FontRequest;I)V
    ...
    invoke-static {p3, p4, p0}, Landroidx/core/provider/f;->c(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;Landroidx/core/util/Consumer;)V
...
.method static e(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/provider/b;II)Landroid/graphics/Typeface;
    .locals 2
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .param p1    # Landroidx/core/provider/FontRequest;
        ...
        .end annotation
    .end param
    .param p2    # Landroidx/core/provider/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param

    .line 1
    invoke-static {p1, p3}, Landroidx/core/provider/e;->a(Landroidx/core/provider/FontRequest;I)Ljava/lang/String;
    ...
    invoke-virtual {p2, p0}, Landroidx/core/provider/b;->b(Landroidx/core/provider/e$e;)V
    ...
    .line 4
    invoke-static {v0, p0, p1, p3}, Landroidx/core/provider/e;->c(Ljava/lang/String;Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/e$e;
    ...
    invoke-direct {v1, v0, p0, p1, p3}, Landroidx/core/provider/e$a;-><init>(Ljava/lang/String;Landroid/content/Context;Landroidx/core/provider/FontRequest;I)V

    .line 8
    :try_start_0
    sget-object p0, Landroidx/core/provider/e;->b:Ljava/util/concurrent/ExecutorService;

    invoke-static {p0, v1, p4}, Landroidx/core/provider/f;->d(Ljava/util/concurrent/ExecutorService;Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
