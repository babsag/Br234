...
.method private static a(Landroidx/core/content/res/ResourcesCompat$f;ILandroid/content/res/ColorStateList;Landroid/content/res/Resources$Theme;)V
    .locals 3
    .param p0    # Landroidx/core/content/res/ResourcesCompat$f;
    ...
    .line 5
    :cond_0
    new-instance v1, Landroidx/core/content/res/ResourcesCompat$e;

    iget-object p0, p0, Landroidx/core/content/res/ResourcesCompat$f;->a:Landroid/content/res/Resources;
    ...
    invoke-direct {v1, p2, p0, p3}, Landroidx/core/content/res/ResourcesCompat$e;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/Configuration;Landroid/content/res/Resources$Theme;)V
...
.method private static b(Landroidx/core/content/res/ResourcesCompat$f;I)Landroid/content/res/ColorStateList;
    .locals 5
    .param p0    # Landroidx/core/content/res/ResourcesCompat$f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 5
    iget-object v3, v2, Landroidx/core/content/res/ResourcesCompat$e;->b:Landroid/content/res/Configuration;

    iget-object v4, p0, Landroidx/core/content/res/ResourcesCompat$f;->a:Landroid/content/res/Resources;
    ...
    iget-object p0, p0, Landroidx/core/content/res/ResourcesCompat$f;->b:Landroid/content/res/Resources$Theme;

    if-nez p0, :cond_0

    iget v3, v2, Landroidx/core/content/res/ResourcesCompat$e;->c:I
    ...
    .line 7
    :cond_1
    iget-object p0, v2, Landroidx/core/content/res/ResourcesCompat$e;->a:Landroid/content/res/ColorStateList;
...
.method private static d(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    .locals 2
    ...
    .line 1
    invoke-static {p0, p1}, Landroidx/core/content/res/ResourcesCompat;->e(Landroid/content/res/Resources;I)Z
...
.method private static e(Landroid/content/res/Resources;I)Z
    ...
    .line 1
    invoke-static {}, Landroidx/core/content/res/ResourcesCompat;->c()Landroid/util/TypedValue;
...
.method private static f(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 10
    ...
    .line 3
    invoke-static/range {v0 .. v8}, Landroidx/core/content/res/ResourcesCompat;->g(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method private static g(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 17
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static getCachedFont(Landroid/content/Context;I)Landroid/graphics/Typeface;
    ...
    invoke-static/range {v0 .. v7}, Landroidx/core/content/res/ResourcesCompat;->f(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method public static getColorStateList(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    .line 2
    invoke-static {v0, p1}, Landroidx/core/content/res/ResourcesCompat;->b(Landroidx/core/content/res/ResourcesCompat$f;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    :cond_0
    invoke-static {p0, p1, p2}, Landroidx/core/content/res/ResourcesCompat;->d(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    .line 4
    invoke-static {v0, p1, v1, p2}, Landroidx/core/content/res/ResourcesCompat;->a(Landroidx/core/content/res/ResourcesCompat$f;ILandroid/content/res/ColorStateList;Landroid/content/res/Resources$Theme;)V
...
.method public static getDrawableForDensity(Landroid/content/res/Resources;IILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-static {p0, p1, p2}, Landroidx/core/content/res/ResourcesCompat$a;->a(Landroid/content/res/Resources;II)Landroid/graphics/drawable/Drawable;
