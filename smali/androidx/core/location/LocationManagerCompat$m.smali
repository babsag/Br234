...
.method private synthetic a(Ljava/util/concurrent/Executor;I)V
    ...
    .line 2
    :cond_0
    iget-object p1, p0, Landroidx/core/location/LocationManagerCompat$m;->a:Landroidx/core/location/GnssStatusCompat$Callback;
...
.method public synthetic b(Ljava/util/concurrent/Executor;I)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/core/location/LocationManagerCompat$m;->a(Ljava/util/concurrent/Executor;I)V
...
.method public synthetic d(Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/core/location/LocationManagerCompat$m;->c(Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
...
.method public synthetic f(Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {p0, p1}, Landroidx/core/location/LocationManagerCompat$m;->e(Ljava/util/concurrent/Executor;)V
...
.method public synthetic h(Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {p0, p1}, Landroidx/core/location/LocationManagerCompat$m;->g(Ljava/util/concurrent/Executor;)V
...
.method public onFirstFix(I)V
    ...
    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/q;-><init>(Landroidx/core/location/LocationManagerCompat$m;Ljava/util/concurrent/Executor;I)V
...
.method public onSatelliteStatusChanged(Landroid/location/GnssStatus;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/p;-><init>(Landroidx/core/location/LocationManagerCompat$m;Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
...
.method public onStarted()V
    ...
    invoke-direct {v1, p0, v0}, Landroidx/core/location/r;-><init>(Landroidx/core/location/LocationManagerCompat$m;Ljava/util/concurrent/Executor;)V
...
.method public onStopped()V
    ...
    invoke-direct {v1, p0, v0}, Landroidx/core/location/o;-><init>(Landroidx/core/location/LocationManagerCompat$m;Ljava/util/concurrent/Executor;)V
