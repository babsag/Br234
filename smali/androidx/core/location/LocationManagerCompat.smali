...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/core/location/LocationManagerCompat;->b:Ljava/util/WeakHashMap;
...
.method static synthetic b(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$i;)Ljava/lang/Boolean;
    .locals 0
...
.method private static c(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    .locals 9
    ...
    .line 3
    invoke-static {p0, p1, p2, p3}, Landroidx/core/location/LocationManagerCompat$b;->a(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    check-cast v3, Landroidx/core/location/LocationManagerCompat$i;

    if-nez v3, :cond_3

    .line 7
    new-instance v3, Landroidx/core/location/LocationManagerCompat$i;

    invoke-direct {v3, p0, p3}, Landroidx/core/location/LocationManagerCompat$i;-><init>(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;)V

    goto :goto_1

    .line 8
    :cond_3
    invoke-virtual {v3}, Landroidx/core/location/LocationManagerCompat$i;->j()V

    .line 9
    :goto_1
    invoke-virtual {v3, p2}, Landroidx/core/location/LocationManagerCompat$i;->i(Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v4, p0, v3}, Landroidx/core/location/h;-><init>(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$i;)V
...
.method static d(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$l;)V
    .locals 3
    .annotation build Landroidx/annotation/GuardedBy;
        value = "sLocationListeners"
    .end annotation
    ...
    .line 1
    sget-object v0, Landroidx/core/location/LocationManagerCompat;->b:Ljava/util/WeakHashMap;

    .line 2
    invoke-virtual {p1}, Landroidx/core/location/LocationManagerCompat$l;->a()Landroidx/core/location/LocationManagerCompat$k;
    ...
    .line 4
    invoke-virtual {p1}, Landroidx/core/location/LocationManagerCompat$l;->n()V
...
.method public static getCurrentLocation(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    .line 2
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/core/location/LocationManagerCompat$d;->a(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    invoke-direct {p0, v0}, Landroidx/core/location/t;-><init>(Landroidx/core/location/LocationManagerCompat$f;)V
    ...
    .line 11
    invoke-virtual {v0, p0, p1}, Landroidx/core/location/LocationManagerCompat$f;->f(J)V
...
.method public static isLocationEnabled(Landroid/location/LocationManager;)Z
    ...
    .line 3
    :try_start_0
    sget-object v4, Landroidx/core/location/LocationManagerCompat;->a:Ljava/lang/reflect/Field;
    ...
    sput-object v4, Landroidx/core/location/LocationManagerCompat;->a:Ljava/lang/reflect/Field;
...
.method public static registerGnssStatusCallback(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;Landroid/os/Handler;)Z
    ...
    .line 3
    :cond_0
    new-instance v0, Landroidx/core/location/LocationManagerCompat$j;

    invoke-direct {v0, p2}, Landroidx/core/location/LocationManagerCompat$j;-><init>(Landroid/os/Handler;)V
...
.method public static registerGnssStatusCallback(Landroid/location/LocationManager;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    .line 5
    invoke-static {p0, v0, p1, p2}, Landroidx/core/location/LocationManagerCompat;->c(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    invoke-static {p0, v1, p1, p2}, Landroidx/core/location/LocationManagerCompat;->c(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
...
.method public static removeUpdates(Landroid/location/LocationManager;Landroidx/core/location/LocationListenerCompat;)V
    ...
    check-cast v3, Landroidx/core/location/LocationManagerCompat$l;
    ...
    .line 4
    :cond_1
    invoke-virtual {v3}, Landroidx/core/location/LocationManagerCompat$l;->a()Landroidx/core/location/LocationManagerCompat$k;

    move-result-object v4

    .line 5
    iget-object v5, v4, Landroidx/core/location/LocationManagerCompat$k;->b:Landroidx/core/location/LocationListenerCompat;
    ...
    .line 8
    invoke-virtual {v3}, Landroidx/core/location/LocationManagerCompat$l;->n()V
    ...
    check-cast v2, Landroidx/core/location/LocationManagerCompat$k;

    .line 11
    sget-object v3, Landroidx/core/location/LocationManagerCompat;->b:Ljava/util/WeakHashMap;
...
.method public static requestLocationUpdates(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Landroidx/core/location/LocationListenerCompat;Landroid/os/Looper;)V
    ...
    .line 17
    invoke-static {p0, p1, p2, p4, p3}, Landroidx/core/location/LocationManagerCompat$e;->b(Landroid/location/LocationManager;Ljava/lang/String;Landroid/location/LocationRequest;Ljava/util/concurrent/Executor;Landroid/location/LocationListener;)V
...
.method public static requestLocationUpdates(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Ljava/util/concurrent/Executor;Landroidx/core/location/LocationListenerCompat;)V
    ...
    .line 3
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/core/location/LocationManagerCompat$e;->b(Landroid/location/LocationManager;Ljava/lang/String;Landroid/location/LocationRequest;Ljava/util/concurrent/Executor;Landroid/location/LocationListener;)V
    ...
    new-instance v2, Landroidx/core/location/LocationManagerCompat$k;

    invoke-direct {v2, p1, p4}, Landroidx/core/location/LocationManagerCompat$k;-><init>(Ljava/lang/String;Landroidx/core/location/LocationListenerCompat;)V

    invoke-direct {v1, v2, p3}, Landroidx/core/location/LocationManagerCompat$l;-><init>(Landroidx/core/location/LocationManagerCompat$k;Ljava/util/concurrent/Executor;)V
    ...
    .line 6
    invoke-static {p0, p1, p2, v1}, Landroidx/core/location/LocationManagerCompat$a;->b(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Landroidx/core/location/LocationManagerCompat$l;)Z
    ...
    .line 7
    :cond_2
    sget-object p3, Landroidx/core/location/LocationManagerCompat;->b:Ljava/util/WeakHashMap;
    ...
    .line 12
    invoke-static {p0, v1}, Landroidx/core/location/LocationManagerCompat;->d(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$l;)V
...
.method public static unregisterGnssStatusCallback(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;)V
    ...
    .line 4
    invoke-static {p0, p1}, Landroidx/core/location/LocationManagerCompat$b;->b(Landroid/location/LocationManager;Ljava/lang/Object;)V
    ...
    check-cast p1, Landroidx/core/location/LocationManagerCompat$i;

    if-eqz p1, :cond_2

    .line 8
    invoke-virtual {p1}, Landroidx/core/location/LocationManagerCompat$i;->j()V
