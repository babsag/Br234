...
.field private h:Landroid/media/ImageWriter;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mLock"
    .end annotation
.end field
...
.field j:Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mLock"
    .end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/camera/core/internal/YuvToJpegProcessor;->a:Landroid/graphics/Rect;
...
.method public constructor <init>(II)V
    ...
    iput-object v0, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->c:Ljava/lang/Object;

    const/4 v0, 0x0

    .line 3
    iput v0, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->e:I

    .line 4
    iput-boolean v0, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->f:Z

    .line 5
    iput v0, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->g:I

    .line 6
    sget-object v0, Landroidx/camera/core/internal/YuvToJpegProcessor;->a:Landroid/graphics/Rect;

    iput-object v0, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->i:Landroid/graphics/Rect;

    .line 7
    iput p1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->d:I

    .line 8
    iput p2, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->b:I
...
.method private synthetic a(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->c:Ljava/lang/Object;

    monitor-enter v0

    .line 2
    :try_start_0
    iput-object p1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->j:Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;
...
.method public synthetic b(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/core/internal/YuvToJpegProcessor;->a(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
...
.method public close()V
    ...
    .line 2
    :try_start_0
    iget-boolean v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->f:Z
    ...
    .line 4
    iput-boolean v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->f:Z

    .line 5
    iget v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->g:I

    const/4 v2, 0x0

    if-nez v1, :cond_1

    iget-object v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->h:Landroid/media/ImageWriter;
    ...
    .line 8
    iget-object v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->j:Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;
...
.method public getCloseFuture()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 4
    :cond_0
    iget-object v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->k:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v1, p0}, Landroidx/camera/core/internal/c;-><init>(Landroidx/camera/core/internal/YuvToJpegProcessor;)V

    invoke-static {v1}, Landroidx/concurrent/futures/CallbackToFutureAdapter;->getFuture(Landroidx/concurrent/futures/CallbackToFutureAdapter$Resolver;)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object v1

    iput-object v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->k:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public onOutputSurface(Landroid/view/Surface;I)V
    ...
    .line 5
    iget v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->b:I
    ...
    iput-object p1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->h:Landroid/media/ImageWriter;
...
.method public onResolutionUpdate(Landroid/util/Size;)V
    ...
    iput-object v1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->i:Landroid/graphics/Rect;
...
.method public process(Landroidx/camera/core/impl/ImageProxyBundle;)V
    ...
    .line 7
    iget-object v2, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->c:Ljava/lang/Object;

    monitor-enter v2

    .line 8
    :try_start_0
    iget-object v5, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->h:Landroid/media/ImageWriter;

    .line 9
    iget-boolean v6, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->f:Z
    ...
    .line 10
    :goto_1
    iget-object v7, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->i:Landroid/graphics/Rect;

    if-eqz v6, :cond_2

    .line 11
    iget v8, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->g:I

    add-int/2addr v8, v4

    iput v8, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->g:I

    .line 12
    :cond_2
    iget v8, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->d:I

    .line 13
    iget v9, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->e:I
    ...
    .line 18
    iget-object v7, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->c:Ljava/lang/Object;
    ...
    .line 19
    :try_start_3
    iget v0, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->g:I

    add-int/lit8 v6, v0, -0x1

    iput v6, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->g:I

    if-nez v0, :cond_3

    iget-boolean v0, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->f:Z
    ...
    :cond_3
    :goto_2
    iget-object v0, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->j:Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;
    ...
    .line 56
    :try_start_c
    iget v6, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->g:I
    ...
    :cond_8
    :goto_a
    iget-object v4, v1, Landroidx/camera/core/internal/YuvToJpegProcessor;->j:Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;
...
.method public setRotationDegrees(I)V
    ...
    .line 2
    :try_start_0
    iput p1, p0, Landroidx/camera/core/internal/YuvToJpegProcessor;->e:I
