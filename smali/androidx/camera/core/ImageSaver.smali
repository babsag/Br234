...
.field private final f:Landroidx/camera/core/ImageSaver$OnImageSavedCallback;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field
...
.method constructor <init>(Landroidx/camera/core/ImageProxy;Landroidx/camera/core/ImageCapture$OutputFileOptions;IILjava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageSaver$OnImageSavedCallback;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/camera/core/ImageSaver;->a:Landroidx/camera/core/ImageProxy;

    .line 3
    iput-object p2, p0, Landroidx/camera/core/ImageSaver;->d:Landroidx/camera/core/ImageCapture$OutputFileOptions;
    ...
    .line 6
    iput-object p7, p0, Landroidx/camera/core/ImageSaver;->f:Landroidx/camera/core/ImageSaver$OnImageSavedCallback;
...
.method private b(Ljava/io/File;Ljava/io/OutputStream;)V
    .locals 3
...
.method private c(Ljava/io/File;Landroid/net/Uri;)Z
    .locals 1
    .param p1    # Ljava/io/File;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    iget-object v0, p0, Landroidx/camera/core/ImageSaver;->d:Landroidx/camera/core/ImageCapture$OutputFileOptions;
    ...
    :cond_1
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/camera/core/ImageSaver;->b(Ljava/io/File;Ljava/io/OutputStream;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private d(Landroidx/camera/core/ImageProxy;I)[B
    .locals 4
    .param p1    # Landroidx/camera/core/ImageProxy;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method private synthetic h(Landroidx/camera/core/ImageSaver$SaveError;Ljava/lang/String;Ljava/lang/Throwable;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/camera/core/ImageSaver;->f:Landroidx/camera/core/ImageSaver$OnImageSavedCallback;
...
.method private synthetic l(Ljava/io/File;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/camera/core/ImageSaver;->a(Ljava/io/File;)V
...
.method private n(Landroidx/camera/core/ImageSaver$SaveError;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroidx/camera/core/q0;-><init>(Landroidx/camera/core/ImageSaver;Landroidx/camera/core/ImageSaver$SaveError;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private o(Landroid/net/Uri;)V
    ...
    invoke-direct {v1, p0, p1}, Landroidx/camera/core/o0;-><init>(Landroidx/camera/core/ImageSaver;Landroid/net/Uri;)V
...
.method private p()Ljava/io/File;
    ...
    .line 1
    :try_start_0
    invoke-direct {p0}, Landroidx/camera/core/ImageSaver;->e()Z
    ...
    iget-object v4, p0, Landroidx/camera/core/ImageSaver;->d:Landroidx/camera/core/ImageCapture$OutputFileOptions;
    ...
    :goto_0
    :try_start_2
    iget-object v2, p0, Landroidx/camera/core/ImageSaver;->a:Landroidx/camera/core/ImageProxy;
    :try_end_2
    ...
    .line 7
    :try_start_4
    iget-object v4, p0, Landroidx/camera/core/ImageSaver;->a:Landroidx/camera/core/ImageProxy;

    iget v5, p0, Landroidx/camera/core/ImageSaver;->c:I

    invoke-direct {p0, v4, v5}, Landroidx/camera/core/ImageSaver;->d(Landroidx/camera/core/ImageProxy;I)[B
    ...
    .line 10
    iget-object v5, p0, Landroidx/camera/core/ImageSaver;->a:Landroidx/camera/core/ImageProxy;
    ...
    iget-object v6, p0, Landroidx/camera/core/ImageSaver;->a:Landroidx/camera/core/ImageProxy;
    ...
    .line 13
    :cond_1
    iget-object v5, p0, Landroidx/camera/core/ImageSaver;->d:Landroidx/camera/core/ImageCapture$OutputFileOptions;
...
.method private r(Landroid/net/Uri;)V
    ...
    .line 4
    iget-object v1, p0, Landroidx/camera/core/ImageSaver;->d:Landroidx/camera/core/ImageCapture$OutputFileOptions;
...
.method a(Ljava/io/File;)V
    ...
    .line 2
    :try_start_0
    invoke-direct {p0}, Landroidx/camera/core/ImageSaver;->f()Z
    ...
    iget-object v2, p0, Landroidx/camera/core/ImageSaver;->d:Landroidx/camera/core/ImageCapture$OutputFileOptions;
    ...
    iget-object v3, p0, Landroidx/camera/core/ImageSaver;->d:Landroidx/camera/core/ImageCapture$OutputFileOptions;
    ...
    .line 11
    :cond_1
    invoke-direct {p0, p1, v1}, Landroidx/camera/core/ImageSaver;->c(Ljava/io/File;Landroid/net/Uri;)Z
    ...
    :cond_3
    :try_start_2
    invoke-direct {p0}, Landroidx/camera/core/ImageSaver;->g()Z
    ...
    invoke-direct {p0, p1, v1}, Landroidx/camera/core/ImageSaver;->b(Ljava/io/File;Ljava/io/OutputStream;)V
...
.method public synthetic i(Landroidx/camera/core/ImageSaver$SaveError;Ljava/lang/String;Ljava/lang/Throwable;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/camera/core/ImageSaver;->h(Landroidx/camera/core/ImageSaver$SaveError;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public synthetic k(Landroid/net/Uri;)V
    ...
    invoke-direct {p0, p1}, Landroidx/camera/core/ImageSaver;->j(Landroid/net/Uri;)V
...
.method public run()V
    ...
    invoke-direct {v2, p0, v0}, Landroidx/camera/core/p0;-><init>(Landroidx/camera/core/ImageSaver;Ljava/io/File;)V
