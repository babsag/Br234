...
.method static synthetic a(Lcom/google/common/util/concurrent/ListenableFuture;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 3
...
.method static synthetic b(Ljava/util/concurrent/Executor;Lcom/google/common/util/concurrent/ListenableFuture;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 1

    .line 1
    new-instance v0, Landroidx/camera/core/impl/k;

    invoke-direct {v0, p1, p2, p3, p4}, Landroidx/camera/core/impl/k;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
...
.method static synthetic c(Lcom/google/common/util/concurrent/ListenableFuture;)V
    .locals 1
...
.method static synthetic d(Ljava/util/List;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/Executor;JZLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/camera/core/impl/m;-><init>(Ljava/util/concurrent/Executor;Lcom/google/common/util/concurrent/ListenableFuture;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    ...
    invoke-direct {p3, p0}, Landroidx/camera/core/impl/j;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;)V
    ...
    .line 4
    new-instance p3, Landroidx/camera/core/impl/DeferrableSurfaces$a;

    invoke-direct {p3, p5, p6, p1}, Landroidx/camera/core/impl/DeferrableSurfaces$a;-><init>(ZLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;Ljava/util/concurrent/ScheduledFuture;)V
...
.method public static surfaceListWithTimeout(Ljava/util/Collection;ZJLjava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/camera/core/impl/l;-><init>(Ljava/util/List;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/Executor;JZ)V
