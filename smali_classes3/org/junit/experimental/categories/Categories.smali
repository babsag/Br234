...
.method public constructor <init>(Ljava/lang/Class;Lorg/junit/runners/model/RunnerBuilder;)V
    ...
    .line 2
    :try_start_0
    invoke-static {p1}, Lorg/junit/experimental/categories/Categories;->r(Ljava/lang/Class;)Ljava/util/Set;

    move-result-object p2

    .line 3
    invoke-static {p1}, Lorg/junit/experimental/categories/Categories;->q(Ljava/lang/Class;)Ljava/util/Set;

    move-result-object v0

    .line 4
    invoke-static {p1}, Lorg/junit/experimental/categories/Categories;->u(Ljava/lang/Class;)Z

    move-result v1

    .line 5
    invoke-static {p1}, Lorg/junit/experimental/categories/Categories;->t(Ljava/lang/Class;)Z
    ...
    invoke-static {p1}, Lorg/junit/experimental/categories/Categories;->m(Lorg/junit/runner/Description;)V
...
.method static synthetic k([Ljava/lang/Class;)Ljava/util/Set;
    .locals 0

    .line 1
    invoke-static {p0}, Lorg/junit/experimental/categories/Categories;->p([Ljava/lang/Class;)Ljava/util/Set;
...
.method static synthetic l(Ljava/util/Set;Ljava/lang/Class;)Z
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lorg/junit/experimental/categories/Categories;->s(Ljava/util/Set;Ljava/lang/Class;)Z
...
.method private static m(Lorg/junit/runner/Description;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/junit/runners/model/InitializationError;
    ...
    .line 1
    invoke-static {p0}, Lorg/junit/experimental/categories/Categories;->o(Lorg/junit/runner/Description;)Z
    ...
    .line 2
    invoke-static {p0}, Lorg/junit/experimental/categories/Categories;->n(Lorg/junit/runner/Description;)V
    ...
    .line 4
    invoke-static {v0}, Lorg/junit/experimental/categories/Categories;->m(Lorg/junit/runner/Description;)V
...
.method private static n(Lorg/junit/runner/Description;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/junit/runners/model/InitializationError;
    ...
    .line 3
    invoke-static {v0}, Lorg/junit/experimental/categories/Categories;->n(Lorg/junit/runner/Description;)V
...
.method private static o(Lorg/junit/runner/Description;)Z
    .locals 1
...
.method private static varargs p([Ljava/lang/Class;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
...
.method private static r(Ljava/lang/Class;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static s(Ljava/util/Set;Ljava/lang/Class;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
